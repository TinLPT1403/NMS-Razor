...
namespace BLL.Services
{
    public class NewsArticleService : INewsArticleService
    {
        ...
        {
            return await _unitOfWork.NewsArticles.GetArticlesWithActiveCategoriesAsync();
        }

        public async Task<IEnumerable<NewsArticle>> SearchArticlesAsync(string? searchTerm, int? categoryId, int? tagId)
        {
            return await _unitOfWork.NewsArticles.SearchArticlesAsync(searchTerm, categoryId, tagId);
        }

        public async Task<IEnumerable<NewsArticle>> GetNewsArticlesReportAsync(DateTime startDate, DateTime endDate)
        {
            return await _unitOfWork.NewsArticles.GetNewsArticlesReportAsync(startDate, endDate);
        }
    }
}
