...
namespace BLL.Services
{
    public class CategoryService : ICategoryService
    {
        ...
        {
            return await _unitOfWork.Categories.GetCategoryDetailById(id);
        }
        ...
        {
            var category = await _unitOfWork.Categories.GetCategoryDetailById(id);
        ...
        {
            return await _unitOfWork.Categories.GetParentCategories();
        }
