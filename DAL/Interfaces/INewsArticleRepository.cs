...
namespace DAL.Interfaces
{
    public interface INewsArticleRepository : IGenericRepository<NewsArticle>
    {
        ...
        Task<IEnumerable<NewsArticle>> GetArticlesWithActiveCategoriesAsync();
        Task<IEnumerable<NewsArticle>> SearchArticlesAsync(string? searchTerm, int? categoryId, int? tagId);
        Task<IEnumerable<NewsArticle>> GetNewsArticlesReportAsync(DateTime startDate, DateTime endDate);
    }
}
